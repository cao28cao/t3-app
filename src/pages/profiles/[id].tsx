...
const ProfilePage: NextPage<InferGetStaticPropsType<typeof getStaticProps>> = ({ 
    ...
    const threads = api.thread.infiniteProfileFeed.useInfiniteQuery({ userId: id }, { getNextPageParam: (lastPage) => lastPage.nextCursor})
        ...
        <>
            ...
            <header className="sticky top-0 z-10 flex items-center border-b bg-white px-4 py-2">
                ...
                <div className="ml-2 flex-grow">
                    ...
                    <div className="text-gray-500">
                        {profile.threadsCount}{" "}{getPlural(profile.threadsCount, "Thread", "Threads")} -{" "}
            ...
            <main>
                <InfiniteThreadList 
                    ...
                    hasMore={threads.hasNextPage}                        fetchNextPage={threads.fetchNextPage}
                />
            </main>
        </>
    );
...
function FollowButton({ isFollowing, userId, onClick }: { isFollowing: boolean, userId: string, onClick: () => void }) {
    return (
        <button onClick={onClick} className={`px-4 py-2 rounded-full text-white font-bold ${isFollowing ? "bg-blue-500" : "bg-blue-400"}`}>
